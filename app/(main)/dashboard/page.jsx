      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            >
              <SafeIcon icon={FiPlus} name={undefined} />
              Create New Page
            </Link>
          </div>
        </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className={`p-3 rounded-xl bg-${stat.color}-100`}>
                  <SafeIcon icon={stat.icon} className={`text-${stat.color}-600 text-xl`} name={undefined} />
                </div>
            ...
            <div className="space-y-4">
              {userPages.map((page, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <SafeIcon icon={FiBarChart} name={undefined} />
                    </Link>
                    <Link
                    ...
                    <a
                      ...
                      title="View Live"
                    >
                      <SafeIcon icon={FiExternalLink} name={undefined} />
                    </a>
                  </div>
                </div>
              ))}
              ...
              {userPages.length === 0 && (
                <div className="text-center py-12">
                  <SafeIcon icon={FiPlus} className="text-gray-400 text-4xl mx-auto mb-4" name={undefined} />
            ...
            <div className="space-y-4">
              ...
              >
                <div className="p-2 bg-indigo-600 rounded-lg group-hover:bg-indigo-700 transition-colors">
                  <SafeIcon icon={FiEdit3} className="text-white" name={undefined} />
                </div>
                <div>
              ...
              >
                <div className="p-2 bg-green-600 rounded-lg group-hover:bg-green-700 transition-colors">
                  <SafeIcon icon={FiBarChart} className="text-white" name={undefined} />
                </div>
                <div>
              ...
              >
                <div className="p-2 bg-purple-600 rounded-lg group-hover:bg-purple-700 transition-colors">
                  <SafeIcon icon={FiSettings} className="text-white" name={undefined} />
                </div>
