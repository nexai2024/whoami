            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <SafeIcon icon={FiStar} className="text-yellow-500 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <SafeIcon icon={FiTrendingUp} className="text-green-500 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <SafeIcon icon={FiUsers} className="text-blue-500 mt-1" />
                  <div>
