...
export const ProductCard = () => { 
  ...
  <div className="items-center bottom-[0.50rem] justify-center left-[0.50rem] absolute top-[0.50rem] flex w-12 h-12 rounded overflow-hidden">
    <Image alt="" className="object-cover w-full h-full max-w-full" src="https://ugc.production.linktr.ee/NTNdVeQFQreuM15hzMxJ_cinnamon_sugar_pancakes.jpg?io=true&size=thumbnail-stack_v1_0" />
  </div>
...
export const BioHeader = () => {
  ...
  <Image alt=""  className="object-contain w-24 h-auto max-w-full rounded-full" src="https://ugc.production.linktr.ee/c74f3276-e60f-4486-955b-a092789190c7_donna-hay-portrait-2022.jpeg?io=true&size=avatar-v3_0" />
